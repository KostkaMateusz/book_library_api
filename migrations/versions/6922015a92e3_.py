...
Revision ID: 6922015a92e3
Revises: 
Create Date: 2022-03-23 00:33:49.278045
...
def upgrade():
    ...
    sa.Column('cover_name', sa.String(length=50), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('cover_name'),
